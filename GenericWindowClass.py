                ...
                if self.ndiNameString == selectNDIstream:
                    ...
                    try:
                        if self.alreadyOpenStreamFlag == 1:
                            print('one stream is already running in SMALL_WINDOW, we change to the next one', self.ndiNameString.upper())
